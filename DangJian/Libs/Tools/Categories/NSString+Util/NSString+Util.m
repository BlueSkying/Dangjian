...
- (NSString *)verticalString {
    ...
    editString = [editString stringByReplacingOccurrencesOfString:@"（"withString:@"︵"];
    editString = [editString stringByReplacingOccurrencesOfString:@"("withString:@"︵"];
    editString = [editString stringByReplacingOccurrencesOfString:@")"withString:@"︶"];
    editString = [editString stringByReplacingOccurrencesOfString:@"）"withString:@"︶"];
    NSMutableString * mStr = [[NSMutableString alloc] initWithString:editString];
    NSInteger count = mStr.length;
