...
+ (void)requestPostUrl:(NSString *)path
   ...
   //设置请求头 token
    ...
    NSString *pathUrl = [NSString stringWithFormat:@"%@%@",InterfaceIPAddress,path];
...
//        }
        ...
        for (UIImage *image in images) {
            ...
            UIImage *compressionImage = [Helper imageWithImage:image scaledToSize:CGSizeMake(300, 300/imageSize.width*imageSize.height)];
            NSData *imageData;
            ...
            [formData appendPartWithFileData:imageData name:uploadName fileName:@"image.jpg" mimeType:@"png/jpeg/jpg"];
        }
