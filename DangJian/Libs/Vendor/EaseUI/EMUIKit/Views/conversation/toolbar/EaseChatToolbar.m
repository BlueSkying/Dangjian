...
- (void)_setupSubviews
{
    ...
    _inputTextView.layer.borderColor = SystemGraySeparatedLineColor.CGColor;
    _inputTextView.layer.borderWidth = 0.65f;
    _inputTextView.layer.cornerRadius = 6.0f;
    _inputTextView.tintColor = Color_system_red;
    ...
    [styleChangeButton setImage:[UIImage imageNamed:@"chatBar_record_icon"] forState:UIControlStateNormal];
    [styleChangeButton setImage:[UIImage imageNamed:@"chatBar_keyboard_icon"] forState:UIControlStateSelected];
    ...
    [self.recordButton setBackgroundImage:[[UIImage imageNamed:@"chatBar_recordBg_icon"] stretchableImageWithLeftCapWidth:10 topCapHeight:10] forState:UIControlStateNormal];
    ...
    [self.faceButton setImage:[UIImage imageNamed:@"chatBar_faceSelected_icon"] forState:UIControlStateNormal];
    [self.faceButton setImage:[UIImage imageNamed:@"chatBar_keyboard_icon"] forState:UIControlStateSelected];
    ...
    [self.moreButton setImage:[UIImage imageNamed:@"chatBar_moreSelected_icon"] forState:UIControlStateNormal];
    [self.moreButton setImage:[UIImage imageNamed:@"chatBar_keyboard_icon"] forState:UIControlStateSelected];
...
- (UIView *)moreView
{
    if (_moreView == nil) {
        ...
        [(EaseChatBarMoreView *)_moreView updateItemWithImage:[UIImage imageNamed:@"chat_photo_icon"]
                                             highlightedImage:[UIImage imageNamed:@"chat_photo_icon"]
                                                        title:@"相册"
                                                      atIndex:0];
        
        [(EaseChatBarMoreView *)_moreView updateItemWithImage:[UIImage imageNamed:@"chat_takingPictures_icon"]
                                             highlightedImage:[UIImage imageNamed:@"chat_takingPictures_icon"]
                                                        title:@"拍照"
                                                      atIndex:1];
