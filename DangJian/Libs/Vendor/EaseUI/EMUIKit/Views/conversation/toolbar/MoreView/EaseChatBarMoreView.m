...
- (void)setupSubviewsForType:(EMChatToolbarType)type
{
    ...
    _photoButton =[EaseChatBarButton buttonWithType:UIButtonTypeCustom];
    [_photoButton setFrame:CGRectMake(insets, 10, CHAT_BUTTON_SIZE , CHAT_BUTTON_SIZE + 30)];
...
//    [_scrollview addSubview:_locationButton];
    ...
    _takePicButton =[EaseChatBarButton buttonWithType:UIButtonTypeCustom];
    [_takePicButton setFrame:CGRectMake(insets * 2 + CHAT_BUTTON_SIZE , 10, CHAT_BUTTON_SIZE , CHAT_BUTTON_SIZE + 30)];
