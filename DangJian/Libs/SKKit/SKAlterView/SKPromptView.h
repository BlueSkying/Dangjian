...
@protocol SKPromptViewDelegate <NSObject>
...
@interface SKPromptView : UIView


#pragma mark -  block
@property (nonatomic, copy) void (^sk_promptViewBlokc)();
...
@property (nonatomic, weak) id<SKPromptViewDelegate>delegate; //delegate
