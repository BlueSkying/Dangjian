...
- (UIButton *)setNavigationRightBarButtonWithtitle:(NSString *)title
    ...
    [rightButton.titleLabel setFont:FONT_17];
...
- (void)setDefaultNavigationLeftBarButton {
    ...
    leftButton.bounds = CGRectMake(0, 0, 50, 44);
...
- (void)setNavigationLeftBarButtonWithtitle:(NSString *)title
                                 TitleColor:(UIColor *)color {
    UIButton *leftButton = [UIButton buttonWithType: UIButtonTypeCustom];
    ...
    [leftButton.titleLabel setFont:FONT_17];
    [leftButton addTarget:self action:@selector(leftButtonCustomTouchUpInside:) forControlEvents:UIControlEventTouchUpInside];
    leftButton.tag = 0;
